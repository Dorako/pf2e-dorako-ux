...
export class AvatarSettings extends SettingsMenuDorakoUX {
  ...
  static get settings() {
    return {
      ...
      "small-creature-token-avatar-size": {
        name: "pf2e-dorako-ux.settings.avatar.small-creature-token-avatar-size.name",
        hint: "pf2e-dorako-ux.settings.avatar.small-creature-token-avatar-size.hint",
        scope: "client",
        type: Number,
        default: 0.8,
        range: {
      ...
      "popout-support": {
        name: "pf2e-dorako-ux.settings.avatar.popout-support.name",
        hint: "pf2e-dorako-ux.settings.avatar.popout-support.hint",
        scope: "world",
        type: Boolean,
        default: true,
        config: true,
      ...
      "hide-when-token-hidden": {
        name: "pf2e-dorako-ux.settings.avatar.hide-when-token-hidden.name",
        hint: "pf2e-dorako-ux.settings.avatar.hide-when-token-hidden.hint",
        scope: "world",
        type: Boolean,
        default: true,
        config: true,
      ...
      "hide-gm-avatar-when-secret": {
        name: "pf2e-dorako-ux.settings.avatar.hide-gm-avatar-when-secret.name",
        hint: "pf2e-dorako-ux.settings.avatar.hide-gm-avatar-when-secret.hint",
        scope: "world",
        config: true,
        default: true,
        type: Boolean,
      ...
      "use-user-avatar": {
        name: "pf2e-dorako-ux.settings.avatar.use-user-avatar.name",
        hint: "pf2e-dorako-ux.settings.avatar.use-user-avatar.hint",
        scope: "world",
        type: Boolean,
        default: false,
        config: true,
